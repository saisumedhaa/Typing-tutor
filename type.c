...
void begin()
{
	...
	clock_t start, end;
	char a[100], c ;
	char b[] = "HELLO TYPING TUTOR UNDER THE GUIDANCE OF TEACER AS WELL AS FOR SELFSTUDY AS FOR AVAILABLE EXPORT THE TRAINING STATISTICS IN THE DIFFERENT FORMATS AND CREATING YOUR OWN TARINING COURTS";
...
void calculate(int correct,int wrong,int timetaken,int y)
{
	int per;
	report *ptr;
	ptr = (report*)malloc(sizeof(report*));
	//wptr = (report*)malloc(sizeof(report*));
